"""Staff & customer-facing models extracted from extensions package."""
...
class Employee(db.Model):
    """Lightweight staff record for performance reporting."""
...
class TableCall(db.Model):
    """A customer-initiated waiter-call event."""
    ...
    reason = db.Column(db.Text, default="service")
    note = db.Column(db.Text, default="")
    status = db.Column(db.Text, default="open", index=True)
